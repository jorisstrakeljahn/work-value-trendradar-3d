...
/**
 * Relevance scale table component displaying the rating scale (0-100)
 * for the Relevance dimension
 */
export default function RelevanceScaleTable() {
  const { t } = useTranslation()

  const ranges = [
    { range: '0-20', key: 'relevanceScale0' },
    { range: '21-40', key: 'relevanceScale20' },
    { range: '41-60', key: 'relevanceScale40' },
    { range: '61-80', key: 'relevanceScale60' },
    { range: '81-100', key: 'relevanceScale80' },
  ]
