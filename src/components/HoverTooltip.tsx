...
export default function HoverTooltip() {
  ...
  return (
    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 glass rounded-2xl px-5 py-3 pointer-events-none z-50 shadow-apple-lg border border-gray-200/50 dark:border-gray-600/50">
